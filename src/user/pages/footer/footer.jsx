...
const Footer = () => {
    return (
        <Box className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
            <Box className="flex flex-col items-center justify-center">
                ...
                <Box className="flex items-center gap-x-8 mt-6">
                ...
                <Box className="flex items-center mt-6">
                    <Typography className="text-base leading-4 text-gray-800">
                        2023 <span className="font-semibold">Medicommerce</span>
                    </Typography>
                    <Box className="border-l border-gray-800 pl-2 ml-2">
